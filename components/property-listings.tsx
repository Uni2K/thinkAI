...
export function PropertyListings() {
    ...
    return (
        <div className="min-h-screen bg-background">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-card border-2 border-primary/20 rounded-2xl p-2 ai-glow">
                                <div className="flex items-center gap-3">
                                    ...
                                    />
                                    <Button onClick={handleSearch} size="lg" disabled={!aiQuery} className="ai-gradient text-white flex-shrink-0 cursor-pointer">
            ...
            {/* Results */}
            <section ref={searchSectionRef} className={`container mx-auto px-4 py-8 border-t border-border  ${!searchStarted ? "invisible" : ""}`}>
